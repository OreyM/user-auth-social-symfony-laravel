...
class ResetController extends AbstractController
{
    ...
    public function request(Request $request, Reset\Request\Handler $handler): Response
    {
        ...
        return $this->render('app/pages/auth/reset/request.html.twig', [
     ...
     */
    public function reset(string $token, Request $request, Reset\Reset\Handler $handler, UserFetcher $fetcher): Response
    {
        if (!$fetcher->existsByResetToken($token)) {
        ...
        return $this->render('app/pages/auth/reset/reset.html.twig', [
            'form' => $form->createView(),
        ]);
    }
}
